const functions = {
    ...
    inLoop: (y) =>{
        var txt = "";
        var x;
        // dont hard code the parameters into the function, 
        // they will be read from the recieved part of the test
        // y doesnt need to be defined as a variable as it is already declared in the parameter
        for (x in y) {
          txt += y[x];
        }
        return txt;
